...
"""La idea sería ahohra hacer cuadros de texto en los que cuente todo lo que se acuerde de "su infancia" de "su familia" etc. Cre

La clase paciente se queda corto porque cualquier lista de atributos se va a quedar corta. Hay que pensar otra forma, por ejemplo, las estructuras que se usan son json, tripletas RDF (objeto:atributo:valor), grafos de conocimiento.


Buscar corpus de información biográfica que me pueden servir: wikibio y otro más.

Comentar todo esto en el estado de la cuestión.
Hacer un apartado de representación del conocimiento coon un subapartado de como represetnar el conocimiento de biografias. Ver TFG de cristina que habla sobre eso.

Trabajar con imagenes, decir que puede decir de la imagen y trabajar esa información.

Pedir la lista de preguntas grande para añadirlas.
"""